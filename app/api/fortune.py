"""算命核心 API（/api/fortune/*）——八字/生肖/星座/塔罗/黄历/合婚/解梦/紫微/智能分析等。"""
...
from app.services.fortune import (
    cache, horoscope_client, tarot_client, bazi_calc, shengxiao_calc,
    xingming_calc, heyun_calc, huangli_svc, jiemeng_svc,
    universal_analyzer, analyze_image,
