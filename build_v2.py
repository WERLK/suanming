...
.app{width:100%;max-width:420px;height:100vh;display:flex;flex-direction:column;background:linear-gradient(180deg,#0f0c29 0%,#1a1a2e 30%,#16213e 70%,#0a0a1a 100%);position:relative;overflow:hidden;box-shadow:0 0 80px rgba(255,215,0,0.12);}
...
.ft .t{display:flex;flex-direction:column;align-items:center;gap:0.1rem;color:rgba(255,255,255,0.3);font-size:0.54rem;cursor:pointer;padding:0.2rem 0.7rem;border-radius:8px;transition:all 0.15s;flex:1;}
...
<div class="app">
  <div class="status">
    <span id="car">中国移动</span>
    <span class="t" id="clk">11:50</span>
  ...
  <div class="sta">
    <div class="d"></div>
    <span>在线 <strong id="oc" style="color:#ffd700;font-weight:700;">14,238</strong> 人</span>
    <span style="margin-left:auto;font-size:0.6rem;opacity:0.33;">今日测算 48,659次</span>
  </div>
  <div class="not"><span>📢</span><span>新用户免费测算3次 · 关注公众号【玄机算命】领688积分 · 大师一对一在线解读 · 每日签到送VIP</span></div>
  <div class="views">
    <!-- 首页 -->
    <div class="page active" id="p-home">
      <div class="sch"><div class="sch-i" onclick="toast('搜索开发中')">🔍 搜索算命、八字、风水、生肖...</div></div>
      ...
      <div class="kb-l">
        <div class="kb" onclick="this.classList.toggle('x')">
          ...
          <div class="kb-b"><div class="kb-c"><p>八字即生辰八字，是出生时的干支历日期。年干支为年柱，月干支为月柱，日干支为日柱，时干支为时柱；共四柱八字。</p><p><strong style="color:#ffd700;">十天干：</strong>甲、乙、丙、丁、戊、己、庚、辛、壬、癸</p><p><strong style="color:#ffd700;">十二地支：</strong>子、丑、寅、卯、辰、巳、午、未、申、酉、戌、亥</p><p><strong style="color:#ffd700;">五行相生：</strong>金生水、水生木、木生火、火生土、土生金</p><p><strong style="color:#ffd700;">五行相克：</strong>金克木、木克土、土克水、水克火、火克金</p><span class="tag">基础</span><span class="tag">八字</span><span class="tag">必读</span></div></div>
        </div>
        <div class="kb" onclick="this.classList.toggle('x')">
          <div class="kb-h"><span class="kb-t">⭐ 紫微斗数入门</span><span class="kb-ar">▼</span></div>
          <div class="kb-b"><div class="kb-c"><p>紫微斗数源于道家，是中国传统命理学最重要的支派之一。</p><p><strong style="color:#ffd700;">十四主星：</strong>紫微、天机、太阳、武曲、天同、廉贞、天府、太阴、贪狼、巨门、天相、天梁、七杀、破军</p><p><strong style="color:#ffd700;">十二宫：</strong>命宫、兄弟、夫妻、子女、财帛、疾厄、迁移、交友、官禄、田宅、福德、父母</p><span class="tag">紫微</span><span class="tag">星曜</span></div></div>
        </div>
      </div>
      <div style="padding:1.2rem;text-align:center;color:rgba(255,255,255,0.28);font-size:0.63rem;">玄机算命网 · 专业命理测算平台<br>联系客服 · 意见反馈 · 关于我们</div>
    </div>
    <!-- 生肖页 -->
    <div class="page" id="p-zod">
      <div class="sch"><div class="sch-i" onclick="toast('搜索生肖')">🔍 搜索你的生肖...</div></div>
      <div class="sec"><h3>十二生肖运势</h3></div>
      <div class="zg">
        <div class="zi" onclick="toast('鼠-开发中')"><span class="em">🐭</span><span class="nm">鼠</span><span class="rk">第一名</span></div>
        <div class="zi" onclick="toast('牛-开发中')"><span class="em">🐮</span><span class="nm">牛</span><span class="rk">第二名</span></div>
        <div class="zi" onclick="toast('虎-开发中')"><span class="em">🐯</span><span class="nm">虎</span><span class="rk">第三名</span></div>
        <div class="zi" onclick="toast('兔-开发中')"><span class="em">🐰</span><span class="nm">兔</span><span class="rk">第四名</span></div>
        <div class="zi" onclick="toast('龙-开发中')"><span class="em">🐲</span><span class="nm">龙</span><span class="rk">第五名</span></div>
        <div class="zi" onclick="toast('蛇-开发中')"><span class="em">🐍</span><span class="nm">蛇</span><span class="rk">第六名</span></div>
        <div class="zi" onclick="toast('马-开发中')"><span class="em">🐴</span><span class="nm">马</span><span class="rk">第七名</span></div>
        <div class="zi" onclick="toast('羊-开发中')"><span class="em">🐑</span><span class="nm">羊</span><span class="rk">第八名</span></div>
        <div class="zi" onclick="toast('猴-开发中')"><span class="em">🐵</span><span class="nm">猴</span><span class="rk">第九名</span></div>
        <div class="zi" onclick="toast('鸡-开发中')"><span class="em">🐔</span><span class="nm">鸡</span><span class="rk">第十名</span></div>
        <div class="zi" onclick="toast('狗-开发中')"><span class="em">🐶</span><span class="nm">狗</span><span class="rk">第十一名</span></div>
        <div class="zi" onclick="toast('猪-开发中')"><span class="em">🐷</span><span class="nm">猪</span><span class="rk">第十二名</span></div>
      </div>
    ...
    <div class="page" id="p-div">
      <div class="sch"><div class="sch-i" onclick="toast('搜索占卜')">🔍 搜索占卜方式...</div></div>
      <div class="sec"><h3>选择占卜方式</h3></div>
      <div class="dl">
        <div class="di" onclick="openM('塔罗牌')"><span class="ic">🀄</span><div class="in"><div class="nm">塔罗牌占卜</div><div class="ds">78张牌 · 爱情/事业/运势全方位解读</div></div><span class="ar">›</span></div>
        ...
        <div class="di" onclick="openM('六爻占卜')"><span class="ic">🎲</span><div class="in"><div class="nm">六爻占卜</div><div class="ds">三钱起卦 · 六亲配六神 · 精准预测</div></div><span class="ar">›</span></div>
    ...
    <div class="page" id="p-kb">
      <div class="sch"><div class="sch-i" onclick="toast('搜索知识')">🔍 搜索命理知识...</div></div>
      ...
      <div class="kb-l">
        <div class="kb" onclick="this.classList.toggle('x')">
          ...
          <div class="kb-b"><div class="kb-c"><p><strong style="color:#ffd700;">一、什么是八字</strong></p><p>八字是一个人出生时的干支历日期，共四柱八个字，用以推算人命运。</p><p><strong style="color:#ffd700;">二、天干地支</strong></p><p>十天干：甲(jiǎ)、乙(yǐ)、丙(bǐng)、丁(dīng)、戊(wù)、己(jǐ)、庚(gēng)、辛(xīn)、壬(rén)、癸(guǐ)</p><p>十二地支：子(zǐ)、丑(chǒu)、寅(yín)、卯(mǎo)、辰(chén)、巳(sì)、午(wǔ)、未(wèi)、申(shēn)、酉(yǒu)、戌(xū)、亥(hài)</p><p><strong style="color:#ffd700;">三、五行生克</strong></p><p>五行相生：金生水、水生木、木生火、火生土、土生金</p><p>五行相克：金克木、木克土、土克水、水克火、火克金</p><p><strong style="color:#ffd700;">四、十神关系</strong></p><p>以日干为中心，与其他天干地支的生克关系定出：比肩、劫财、食神、伤官、正财、偏财、正官、七杀、正印、偏印。</p><span class="tag">基础</span><span class="tag">八字</span><span class="tag">必读</span></div></div>
        </div>
        <div class="kb" onclick="this.classList.toggle('x')">
          <div class="kb-h"><span class="kb-t">⭐ 紫微斗数详解</span><span class="kb-ar">▼</span></div>
          <div class="kb-b"><div class="kb-c"><p>紫微斗数，中国传统命理学的重要支派，以星宿配合十二宫的术数算命方法。</p><p><strong style="color:#ffd700;">十四主星详解：</strong></p><p>北斗七星：紫微（帝星）、天机（谋臣）、太阳（光明）、武曲（财星）、天同（福星）、廉贞（囚星）、天府（禄库）</p><p>南斗七星：太阴（月亮）、贪狼（桃花）、巨门（暗星）、天相（印星）、天梁（寿星）、七杀（将星）、破军（耗星）</p><p><strong style="color:#ffd700;">十二宫位：</strong>命宫、兄弟、夫妻、子女、财帛、疾厄、迁移、交友、官禄、田宅、福德、父母</p><span class="tag">紫微斗数</span><span class="tag">星曜</span><span class="tag">十二宫</span></div></div>
        </div>
        <div class="kb" onclick="this.classList.toggle('x')">
          <div class="kb-h"><span class="kb-t">☯ 易经六十四卦解读</span><span class="kb-ar">▼</span></div>
          <div class="kb-b"><div class="kb-c"><p>《易经》是中国最古老的经典之一，被誉为"群经之首，大道之源"。</p><p><strong style="color:#ffd700;">八卦：</strong>乾(天)、坤(地)、震(雷)、巽(风)、坎(水)、离(火)、艮(山)、兑(泽)</p><p><strong style="color:#ffd700;">六十四卦精选：</strong></p><p>乾为天：刚健中正，自强不息</p><p>坤为地：柔顺伸展，厚德载物</p><p>水雷屯：起始维艰，终于亨通</p><p>山水蒙：启蒙奋发，循规蹈矩</p><p>水天需：等待时机，需求需耐心</p><span class="tag">易经</span><span class="tag">卦象</span><span class="tag">八卦</span></div></div>
        </div>
        <div class="kb" onclick="this.classList.toggle('x')">
  ...
  <!-- 底部标签栏 -->
  <div class="ft">
    <div class="t a" onclick="swT('home',this)"><span class="ti">🏠</span>首页</div>
    <div class="t" onclick="swT('zod',this)"><span class="ti">🐉</span>生肖</div>
    <div class="t" onclick="swT('div',this)"><span class="ti">🔮</span>占卜</div>
    <div class="t" onclick="swT('kb',this)"><span class="ti">📚</span>知识</div>
  </div>
</div>
</div>
<script>
function upClk(){var d=new Date(),h=d.getHours().toString().padStart(2,'0'),m=d.getMinutes().toString().padStart(2,'0');document.getElementById('clk').textContent=h+':'+m;}
setInterval(upClk,1000);upClk();
var bl=78;
function upBat(){document.getElementById('bf').style.width=bl+'%';document.getElementById('bt').textContent=bl+'%';var f=document.getElementById('bf');f.classList.remove('lo','mi');if(bl<=20)f.classList.add('lo');else if(bl<=50)f.classList.add('mi');}
if(navigator.getBattery){navigator.getBattery().then(function(b){bl=Math.round(b.level*100);upBat();b.addEventListener('levelchange',function(){bl=Math.round(b.level*100);upBat();});});}else{setInterval(function(){bl=Math.max(15,Math.min(100,bl+(Math.random()>0.5?1:-1)));upBat();},30000);}
upBat();
function upSig(){var bs=document.querySelectorAll('#sig i');var r=Math.random();bs.forEach(function(b,i){b.classList.remove('w','m','o');if(r<0.12&&i>1)b.classList.add('o');else if(r<0.3&&i>2)b.classList.add('m');});}
setInterval(upSig,5000);upSig();
if(navigator.connection){navigator.connection.addEventListener('change',function(){var e=navigator.connection.effectiveType;document.getElementById('nt').textContent=e==='4g'?'4G':e==='3g'?'3G':e==='2g'?'2G':'5G';});}
function upOC(){document.getElementById('oc').textContent=(14000+Math.floor(Math.random()*1200)).toLocaleString();}
setInterval(upOC,8000);upOC();
function swT(p,t){document.querySelectorAll('.page').forEach(function(x){x.classList.remove('active');});document.querySelectorAll('.ft .t').forEach(function(x){x.classList.remove('a');});var pg=document.getElementById('p-'+p);if(pg)pg.classList.add('active');if(t)t.classList.add('a');}
...
function openM(n){toast(n+' - 功能开发中，敬请期待...');}
</script>
</body>
</html>"""
...
print('Modules:', html.count('class="item"'))
