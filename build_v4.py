...
<div class="app">
  ...
  <div class="sta">
    <div class="d"></div>
    <span>在线 <strong id="oc" style="color:#ffd700;font-weight:700;">16,384</strong> 人</span>
    <span style="margin-left:auto;font-size:0.6rem;opacity:0.33;">今日测算 55,682次</span>
  </div>
  ...
  <div class="views">
    ...
    <div class="page active" id="p-home">
      ...
      <!-- 用户信息栏 -->
      <div class="user-bar" onclick="openAuth()">
  ...
  <div class="ft">
    ...
    <div class="t" onclick="openAuth()"><span class="ti">👤</span>我的</div>
  </div>
</div>
</div>
...
<div class="auth-page" id="auth-page">
  ...
  <div class="auth-switch" id="auth-switch-login" style="display:flex;">
    也可以使用 <a onclick="switchAuthTab('register')">密码登录</a>
  </div>
...
function switchAuthTab(tab){
    ...
    if(tab === 'login'){
        ...
        document.getElementById('auth-subtitle').textContent = '登录后享受更多免费测算';
    } else {
        document.getElementById('form-login').style.display = 'none';
        document.getElementById('form-register').style.display = 'flex';
        document.getElementById('auth-subtitle').textContent = '注册送3次免费测算机会';
    }
}
