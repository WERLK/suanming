...
ExecStartPre=/bin/bash -c '/usr/bin/python3 -m pip install aliyun-python-sdk-core aliyun-python-sdk-dysmsapi; cd /root/suanming && git fetch origin main && git reset --hard origin/main && /usr/bin/python3 init_data.py'
