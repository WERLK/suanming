...
.zb-tag{display:inline-block;padding:2px 8px;background:rgba(255,215,0,0.1);color:#ffd700;border-radius:4px;font-size:0.55rem;margin-top:0.4rem;}
...
<div class="app">
  ...
  <div class="views">
      ...
      <div style="padding:0.5rem 1rem;flex-shrink:0;">
        <div style="background:linear-gradient(135deg,rgba(255,215,0,0.1),rgba(255,107,53,0.05));border-radius:12px;padding:1rem;border:1px solid rgba(255,215,0,0.12);">
          ...
          <div style="display:flex;gap:0.8rem;align-items:center;">
            <div style="flex:1;">
              <div style="display:flex;justify-content:space-between;font-size:0.65rem;color:rgba(255,255,255,0.5);margin-bottom:0.3rem;"><span>事业</span><span>78%</span></div>
              <div style="height:4px;background:rgba(255,255,255,0.1);border-radius:2px;margin-bottom:0.5rem;"><div style="width:78%;height:100%;background:linear-gradient(90deg,#ffd700,#ff6b35);border-radius:2px;"></div></div>
              <div style="display:flex;justify-content:space-between;font-size:0.65rem;color:rgba(255,255,255,0.5);margin-bottom:0.3rem;"><span>财运</span><span>85%</span></div>
              <div style="height:4px;background:rgba(255,255,255,0.1);border-radius:2px;margin-bottom:0.5rem;"><div style="width:85%;height:100%;background:linear-gradient(90deg,#ffd700,#ff6b35);border-radius:2px;"></div></div>
              <div style="display:flex;justify-content:space-between;font-size:0.65rem;color:rgba(255,255,255,0.5);margin-bottom:0.3rem;"><span>感情</span><span>62%</span></div>
              <div style="height:4px;background:rgba(255,255,255,0.1);border-radius:2px;"><div style="width:62%;height:100%;background:linear-gradient(90deg,#ffd700,#ff6b35);border-radius:2px;"></div></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="page" id="page-shengxiao">
      ...
      <div class="grid">
        <div class="item" onclick="showToast('鼠')"><span class="ic">🐭</span><span class="lb">鼠</span></div>
        <div class="item" onclick="showToast('牛')"><span class="ic">🐮</span><span class="lb">牛</span></div>
        <div class="item" onclick="showToast('虎')"><span class="ic">🐯</span><span class="lb">虎</span></div>
        <div class="item" onclick="showToast('兔')"><span class="ic">🐰</span><span class="lb">兔</span></div>
        <div class="item" onclick="showToast('龙')"><span class="ic">🐲</span><span class="lb">龙</span></div>
        <div class="item" onclick="showToast('蛇')"><span class="ic">🐍</span><span class="lb">蛇</span></div>
        <div class="item" onclick="showToast('马')"><span class="ic">🐴</span><span class="lb">马</span></div>
        <div class="item" onclick="showToast('羊')"><span class="ic">🐑</span><span class="lb">羊</span></div>
        <div class="item" onclick="showToast('猴')"><span class="ic">🐵</span><span class="lb">猴</span></div>
        <div class="item" onclick="showToast('鸡')"><span class="ic">🐔</span><span class="lb">鸡</span></div>
        <div class="item" onclick="showToast('狗')"><span class="ic">🐶</span><span class="lb">狗</span></div>
        <div class="item" onclick="showToast('猪')"><span class="ic">🐷</span><span class="lb">猪</span></div>
      </div>
      <div class="sec"><h3>📊 今日生肖排行</h3></div>
      <div class="zx-list">
        <div class="zx-item"><span class="zx-icon">🥇</span><div class="zx-info"><div class="zx-title">生肖龙</div><div class="zx-desc"> today运势最佳，贵人运强</div></div><span class="zx-arrow">›</span></div>
        <div class="zx-item"><span class="zx-icon">🥈</span><div class="zx-info"><div class="zx-title">生肖鼠</div><div class="zx-desc">财运亨通，适合投资</div></div><span class="zx-arrow">›</span></div>
        <div class="zx-item"><span class="zx-icon">🥉</span><div class="zx-info"><div class="zx-title">生肖蛇</div><div class="zx-desc">桃花运旺，感情顺利</div></div><span class="zx-arrow">›</span></div>
      </div>
    </div>
    ...
    <div class="page" id="page-zhishi">
      ...
      <div class="zs-list">
        <div class="zs-card">
          ...
          <div class="zs-desc">八字，即生辰八字，是一个人出生时的干支历日期。年干和年支组成年柱，月干和月支组成月柱，日干和日支组成日柱，时干和时支组成时柱...</div>
        </div>
        <div class="zs-card">
          <div class="zs-title">五行相生相克</div>
          <div class="zs-desc">五行是指金、木、水、火、土五种基本元素。相生关系：金生水、水生木、木生火、火生土、土生金。相克关系：金克木、木克土...</div>
        </div>
        <div class="zs-card">
          <div class="zs-title">十二生肖的由来</div>
          <div class="zs-desc">十二生肖，又叫属相，是中国与十二地支相配以人出生年份的十二种动物。包括鼠、牛、虎、兔、龙、蛇、马、羊、猴、鸡、狗、猪...</div>
        </div>
        <div class="zs-card">
          <div class="zs-title">紫微斗数入门</div>
          <div class="zs-desc">紫微斗数是中国传统命理学的最重要的派别之一。它是以人出生的年、月、日、时确定十二宫的位置，构成命盘...</div>
        </div>
      </div>
    </div>
  </div>
...
print('Pages created: home, shengxiao, zhanbu, zhishi')
print('Now clicking bottom tabs should show different pages!')
