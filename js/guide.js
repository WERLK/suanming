...
window.startGuide = (function() {
    ...
    function injectStyle() {
        ...
        style.textContent = ''
            ...
            + '  background:linear-gradient(180deg,rgba(22,22,45,0.98),rgba(10,14,31,0.98));'
            + '  border:1px solid rgba(232,184,75,0.25);border-radius:16px;'
            ...
            + '}'
            + '#__guideTooltip h3 {'
            + '  color:#e8b84b;font-size:1.05rem;margin:0 0 0.6rem;'
            + '}'
            + '#__guideTooltip p {'
            ...
            + '  background:#e8b84b;width:18px;border-radius:3px;'
            + '}'
            ...
            + '.guide-btn-next {'
            + '  background:linear-gradient(135deg,#e8b84b,#d4a017);color:#101828;'
            + '}'
